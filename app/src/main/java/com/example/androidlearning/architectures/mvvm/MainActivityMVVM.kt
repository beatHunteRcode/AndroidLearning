 ...
 * - ViewModel: Acts as a bridge between the View and the Model. It exposes data to the View through a StateFlow mechanism represented by [GameViewModel.stateFlow]. It also manages the lifecycle of the data and ensures the View only receives relevant updates. Events are stored in [GameEvents] and handled by [GameViewModel.handleScreenEvents]
 */
